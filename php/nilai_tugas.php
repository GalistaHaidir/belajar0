...
$query .= " ORDER BY cm.meeting_number ASC, u.name ASC";
...
<head>
    ...
    <title>Daftar Nilai Tugas Individu | Belajaro</title>
            ...
            <main class="content px-4 py-4">
                <div class="main-content">
                    <div class="container-fluid">
                        <h2 class="mb-4 fw-bold">📋 Daftar Nilai Tugas Individu</h2>

                        <!-- Form Pencarian -->
                        <div class="card-body">
                            <form method="get" action="nilai_tugas.php" class="row g-2 align-items-center mb-4">
                                <!-- Input Cari -->
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="bi bi-search"></i></span>
                                        <input type="text" class="form-control" id="cari" name="cari" placeholder="Cari nama siswa / tugas..." value="<?= htmlspecialchars($cari) ?>">
                                    </div>
                                </div>
                                ...
                                <!-- Tombol Reset -->
                                <div class="col-auto">
                                    <a href="nilai_tugas.php" class="btn btn-outline-secondary btn-sm">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="fw-medium"><?= htmlspecialchars($row['nama_siswa']) ?></div>
                                                </td>
                                                <td>
                                                    <span class="text-muted"><?= htmlspecialchars($row['course_name']) ?></span>
                                                </td>
                                                <td>
                                                    <span><?= htmlspecialchars($row['judul_tugas']) ?></span>
                                                </td>
                                                <td>
                                                    <span>Pertemuan <?= $row['meeting_number'] ?> - <?= htmlspecialchars($row['judul_pertemuan']) ?></span>
                                                </td>
                                                ...
                                                <td>
                                                    <?= date('d M Y H:i', strtotime($row['waktu_kumpul'])) ?>
                                                </td>
                                            </tr>
                                        <?php endwhile; ?>
                                    </tbody>
